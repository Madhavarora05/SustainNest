...
<head>
    ...
    <title>All Blogs - FarmWise Connect</title>
...
<body>
    ...
    <?php
    // Fetch all blogs
    $query = "SELECT * FROM blogs ORDER BY published_date DESC"; // You can change the order as needed
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "
            <div class='blog-card' data-title='$title' data-author='$author' style='width: calc(50% - 10px); margin: 5px; box-sizing: border-box;'>
    ...
    <script>
        // Your JavaScript code for like functionality, search filtering, etc.
